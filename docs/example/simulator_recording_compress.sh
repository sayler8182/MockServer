...
rm "${recording_compressed_path}"

ffmpeg -i "${recording_path}" -vcodec h264 -b:v 600k -acodec mp3 "${recording_compressed_path}"

rm "${recordings_path}"
mv "${recording_compressed_path}" "${recordings_path}"